        ...
        {wordLists && wordLists.length === 0 ? (
          <Card className="border-2 border-dashed border-slate-200">
            <CardContent className="py-16 text-center">
              ...
              <Button onClick={() => setCreateDialogOpen(true)} size="lg" className="shadow-lg shadow-violet-200">
                <Plus className="w-5 h-5 mr-2" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {wordLists?.map((list, index) => {
              ...
              return (
                ...
                >
                  {/* Gradient accent bar */}
                  <div className={`absolute top-0 left-0 right-0 h-1 bg-gradient-to-r ${accentColors[colorIndex]}`} />
                    ...
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          <div className={`h-10 w-10 rounded-xl ${bgColors[colorIndex]} flex items-center justify-center`}>
