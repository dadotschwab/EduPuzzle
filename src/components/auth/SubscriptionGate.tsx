 ...
 */
export function SubscriptionGate({ children, fallback, feature }: SubscriptionGateProps) {
 ...
 */
function UpgradePrompt({ feature, daysRemaining, isTrial }: UpgradePromptProps) {
